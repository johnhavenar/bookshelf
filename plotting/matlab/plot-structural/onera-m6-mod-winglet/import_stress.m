...
% Import the data
tbl = readtable("C:\Users\jackh\OneDrive\MATLAB\aeroelasticity_research\onera-m6-modified\mod-winglet\reports\fsi\stress-data\report-stress-data-"+alpha+"-"+M+".out", opts);
