function [x,y,z,alpha,M] = importDisp(alpha,M,dataset,location,section)
...
% Import the data
tbl = readtable("C:\Users\jackh\OneDrive\MATLAB\aeroelasticity_research\onera-m6-modified\mod-extension\reports\fsi\displacement-data\report-displacement-data-"+alpha+"-"+M+".out", opts);
