...
% Import the data
tbl = readtable("C:\Users\jackh\OneDrive\MATLAB\aeroelasticity_research\onera-m6-modified\mod-winglet\reports\fsi\aero-coefs\report-aero-coefs-"+alpha+"-"+M+".out", opts);
