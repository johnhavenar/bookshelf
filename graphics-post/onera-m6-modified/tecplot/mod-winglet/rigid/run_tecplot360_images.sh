...
for AoA in ${AnglesOfAttack[@]}; do
	...
	for M in ${MachNumbers[@]}; do
        ...
        MACH_NUMBER_IMAGE_DIR=/mnt/d/Aeroelasticity/onera-m6-modified/mod-winglet/results/rigid/images/fluid/contour-frames/mach-number/$AoA-$M
        mkdir -p $MACH_NUMBER_IMAGE_DIR
        # Directory of pressure image files.
        PRESSURE_IMAGE_DIR=/mnt/d/Aeroelasticity/onera-m6-modified/mod-winglet/results/rigid/images/fluid/contour-frames/pressure/$AoA-$M
        mkdir -p $PRESSURE_IMAGE_DIR
        # Directory of velocity image files.
        VELOCITY_IMAGE_DIR=/mnt/d/Aeroelasticity/onera-m6-modified/mod-winglet/results/rigid/images/fluid/contour-frames/velocity/$AoA-$M
